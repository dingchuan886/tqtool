...
public class sync_wapchetuan_194_48 {

	private static final String tomcat = "tomcat2";
	private static final String app = "wapchetuan";
	...
	private static final String contain_ftl = "ftl|xml";// ftl|jar|xml|xls|jsp
	private static final String contain_class = "class|xml";
	private static final String contain_html = "css";// css|js|xml|jpg|png|gif";	//注意：html和js不能轻易更新
