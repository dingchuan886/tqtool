...
public class sync_149_invoice {

	private static final String tomcat = "tomcat1";	//tomcat1
	private static final String app = "invoice";	//wct|invoice
	...
	private static final String contain_class = "class|xml";	//|xml
