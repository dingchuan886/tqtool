...
public class sync_159_mdis {

	private static final String tomcat = "tomcat1";	
	private static final String app = "mdis";	
	

	private static final boolean ftl_boo = false;	//false|true
	private static final boolean class_boo = false;	
	private static final boolean html_boo = true;

	private static final String contain_ftl = "ftl";		// ftl|jar|xml|xls|jsp|json
	private static final String contain_class = "class";	//|xml|properties
	private static final String contain_html = "*";		// css|js|jpg|gif|png|PNG|eot|woff|ttf|sv             g;	//注意：html和js不能轻易更新
...
//	private static Map<String, String> sftpDetails_143;
	private static Map<String, String> sftpDetails_159;
...
//		sftpDetails_143.put(SFTPConstants.SFTP_REQ_PORT, "22");
		//
		sftpDetails_159 = new HashMap<String, String>();
		sftpDetails_159.put(SFTPConstants.SFTP_REQ_HOST, "112.124.119.159");
		sftpDetails_159.put(SFTPConstants.SFTP_REQ_USERNAME, "root");
		sftpDetails_159.put(SFTPConstants.SFTP_REQ_PASSWORD, "Jctain1957");
		sftpDetails_159.put(SFTPConstants.SFTP_REQ_PORT, "22");
//		//
...
//		
	...
	public static void main(String[] args) throws Exception {
		...
		Map<String, String> sftpDetails = sftpDetails_159;
