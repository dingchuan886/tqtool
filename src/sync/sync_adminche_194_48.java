...
public class sync_adminche_194_48 {

	private static final String tomcat = "tomcat1";
	private static final String app = "adminche";
	...
	private static final String contain_html = "";// css|js|xml|jpg|png|gif|html|less|woff|ttf";	//注意：html和js不能轻易更新
