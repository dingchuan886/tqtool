...
public class sync_chetuan_194_48 {

	private static String tomcat = "tomcat1";
	...
	private static final String contain_ftl = "ftl";// |xml|json|jar|xls
	private static final String contain_class = "class";// |xml|properties
	private static final String contain_html = "js";// |js|xml|jpg|png|gif";
													// //注意：html和js不能轻易更新
