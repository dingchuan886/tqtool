...
public class sync_252 {

	private static final String tomcat = "tomcat1";
	private static final String app = "imgupload";//
	...
	private static final String contain_ftl = "ftl";// |js|css|jpg|woff
	...
	static {
		...
		sftpDetails_252.put(SFTPConstants.SFTP_REQ_PASSWORD, "qiandao@315");
	...
	public static void main(String[] args) throws Exception {
		...
		Map<String, String> sftpDetails = sftpDetails_252;
