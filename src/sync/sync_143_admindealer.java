...
public class sync_143_admindealer {

	private static final String tomcat = "tomcat1";	//tomcat1|tomcat2|tomcat3
	private static final String app = "admindealer";	//adminche|che
	...
	private static final String contain_html = "css|js|jpg|gif|png|PNG";		// css|js|jpg|gif|png|PNG;	//注意：html和js不能轻易更新
