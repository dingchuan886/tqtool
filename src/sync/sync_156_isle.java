...
public class sync_156_isle {

	private static final String tomcat = "tomcat4";	//tomcat1|tomcat2|tomcat3
	private static final String app = "isle";	//adminche|che
...
//	private static Map<String, String> sftpDetails_143;0
	private static Map<String, String> sftpDetails_156;
...
//		sftpDetails_143.put(SFTPConstants.SFTP_REQ_PORT, "22");
		//
		sftpDetails_156 = new HashMap<String, String>();
		sftpDetails_156.put(SFTPConstants.SFTP_REQ_HOST, "115.159.39.156");
		sftpDetails_156.put(SFTPConstants.SFTP_REQ_USERNAME, "root");
		sftpDetails_156.put(SFTPConstants.SFTP_REQ_PASSWORD, "qiandao@315");
		sftpDetails_156.put(SFTPConstants.SFTP_REQ_PORT, "22");
//		//
...
//		
	...
	public static void main(String[] args) throws Exception {
		...
		Map<String, String> sftpDetails = sftpDetails_156;
