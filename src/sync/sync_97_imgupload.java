...
public class sync_97_imgupload {

	private static String tomcat = "tomcat1"; // tomcat1|tomcat2|tomcat3
	private static final String app = "imgupload"; // adminche|che
	...
	private static final String contain_ftl = "ftl|xml"; // ftl|jar|xml|xls|jsp|json
	private static final String contain_class = "class|xml"; // |xml|properties
	private static final String contain_html = "css|js|jpg|gif|png|PNG|swf"; // css|js|jpg|gif|png|PNG;

	// 设置主机ip，端口，用户名，密码
	private static Map<String, String> sftpDetails_97; //	4s

	static {
		//
		sftpDetails_97 = new HashMap<String, String>();
		sftpDetails_97.put(SFTPConstants.SFTP_REQ_HOST, "182.254.245.97");
		sftpDetails_97.put(SFTPConstants.SFTP_REQ_USERNAME, "root");
		sftpDetails_97.put(SFTPConstants.SFTP_REQ_PASSWORD, "qiandao@31588");
		sftpDetails_97.put(SFTPConstants.SFTP_REQ_PORT, "22");
	...
	private static Map<String, String> sftpDetails = sftpDetails_97;
