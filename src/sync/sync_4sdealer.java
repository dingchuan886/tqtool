...
public class sync_4sdealer {
	...
	private static final String contain_ftl = "ftl";// ftl|jar|xml|xls
	...
	static {
		...
		sftpDetails_48.put(SFTPConstants.SFTP_REQ_HOST, "192.168.2.48");
	...
	public static void main(String[] args) throws Exception {
		...
		// ftl
		if (ftl_boo) {
			src = "D:\\workspace_java\\dealer4s\\WebContent\\WEB-INF\\"; // 本地文件名
			dst = "/data/app/" + tomcat + "/webapps/4sdealer/WEB-INF/"; // 目标文件名
			putDirectory(src, dst, chSftp, contain_ftl);
		}
		// class
		if (class_boo) {
			src = "D:\\workspace_java\\dealer4s\\build\\classes\\"; // 本地文件名
			dst = "/data/app/" + tomcat + "/webapps/4sdealer/WEB-INF/classes/"; // 目标文件名
