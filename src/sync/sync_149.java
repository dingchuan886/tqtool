...
public class sync_149 {

	private static final String tomcat = "tomcat2";
	private static final String app = "wct";	//wct|invoice
	...
	private static final String contain_class = "properties";	//class|xml|properties
	private static final String contain_html = "css";// |js|xml|jpg|png|gif";	//注意：html和js不能轻易更新
	...
	static {
		...
		sftpDetails_149.put(SFTPConstants.SFTP_REQ_PASSWORD, "qiandao@31588");
...
//			dst = "/data/app/apache2/"+app+"_html/";
