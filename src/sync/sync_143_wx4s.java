...
public class sync_143_wx4s {

	private static String tomcat = "tomcat8"; // tomcat1|tomcat2|tomcat3
	private static final String app = "wx4s"; // adminche|che
	...
	private static final String contain_html = "css"; // css|js|jpg|gif|png|PNG;
														// //注意：html和js不能轻易更新
...
//	private static Map<String, String> sftpDetails_252;
	...
	static {
		...
		// sftpDetails_171.put(SFTPConstants.SFTP_REQ_PASSWORD, "qiandao@315");
...
//		sftpDetails_252.put(SFTPConstants.SFTP_REQ_PASSWORD, "qiandao@3158");
