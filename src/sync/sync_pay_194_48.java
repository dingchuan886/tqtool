...
public class sync_pay_194_48 {
	...
	private static final String contain_ftl = "ftl|";// jar|xml|properties|png|js|css|jpg|eot|svg|ttf|woff|gif|swf|
	private static final String contain_class = "class";
	private static final String contain_html = "js";// |js|xml|jpg|png|gif";	//注意：html和js不能轻易更新
...
//		sftpDetails_194.put(SFTPConstants.SFTP_REQ_PORT, "22");
	...
	public static void main(String[] args) throws Exception {
		...
		Map<String, String> sftpDetails = sftpDetails_149;
