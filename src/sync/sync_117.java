...
public class sync_117 {

	private static final String tomcat = "tomcat1";
	private static final String app = "finance";	//invoice	finance		che
	...
	private static final String contain_class = "class|xml|properties";	//|properties
	...
	public static void main(String[] args) throws Exception {
		...
		Map<String, String> sftpDetails = sftpDetails_117;
