...
public class sync_off_143 {
	...
	private static final String contain_html = "css|js";// |js|xml|jpg|png|gif";	//注意：html和js不能轻易更新
	...
	public static void main(String[] args) throws Exception {
		...
		String src = "D:/nginx-1.4.7/che_html/tuku/index.htm";
		String dst = "/data/app/nginx/che_html/tuku/index.htm";
