...
public class sync_194_finance {

	private static String tomcat = "tomcat2";
	private static final String app = "finance";	//invoice	finance
	...
	private static final String contain_class = "class|xml";	//properties|class|xml
	private static final String contain_html = "js|xml|jpg|png|gif|html|css";// js|xml|jpg|png|gif|html|css;	//注意：html和js不能轻易更新
